...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 15, 2026 at 12:34 AM
...
(5, 'UHL-09', 'Mujahid', 'Saddiqa', 'Active'),
(7, 'USM-1526', 'Hussain', 'Ali', 'Active');
...
INSERT INTO `complaints` (`id`, `student_id`, `name`, `email`, `phone`, `subject`, `message`, `admin_reply`, `status`, `created_at`) VALUES
(4, 36, 'Bakar Zia', 'Bakarzia@gmail.com', '03077413835', 'Fee issue', 'Need your help in fee matter', NULL, 'Pending', '2026-06-13 05:05:27');
...
(8, 35, 5000.00, 'June 2026', 'TMS272740', NULL, 'Pending'),
(9, 36, 5000.00, 'June 2026', 'TMS273613', NULL, 'Pending');
...
INSERT INTO `routes` (`id`, `bus_number`, `route_name`, `city`) VALUES
(13, 'UHL-09', 'Arifwala', 'Arifwala');
...
INSERT INTO `students` (`id`, `name`, `roll_no`, `email`, `password`, `contact`, `status`, `route_id`, `image`) VALUES
(35, 'Muhammad Usman', 'BBIS-22-10', 'musman.amz987@gmail.com', 'Usmanzia#321', '03081201338', 'Approved', 13, ''),
(36, 'Bakar Zia', 'BBIS-22-56', 'Bakarzia@gmail.com', 'Bakar#321', '03081201596', 'Approved', 13, NULL);
...
ALTER TABLE `fees`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fees_ibfk_1` (`student_id`);
...
ALTER TABLE `maintenance`
  ADD PRIMARY KEY (`id`),
  ADD KEY `maintenance_ibfk_1` (`bus_id`);
...
ALTER TABLE `students`
  ...
  ADD KEY `students_ibfk_1` (`route_id`);
...
--
ALTER TABLE `maintenance`
  ADD CONSTRAINT `maintenance_ibfk_1` FOREIGN KEY (`bus_id`) REFERENCES `buses` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `students`
--
ALTER TABLE `students`
  ADD CONSTRAINT `students_ibfk_1` FOREIGN KEY (`route_id`) REFERENCES `routes` (`id`) ON DELETE CASCADE;
COMMIT;
